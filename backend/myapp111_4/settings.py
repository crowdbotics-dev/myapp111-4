"""
Django settings for myapp111_4 project.
...
WSGI_APPLICATION = 'myapp111_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "myapp111_4 API",
    "DESCRIPTION": "API documentation for myapp111_4 App",
    "VERSION": "v1",
}
